...
public class ZooKeeperClient {
    ...
    public static Credentials digestCredentials(String username, String password) {
        Preconditions.checkArgument(CompareUtils.isNotBlank(username));
    ...
    public static Credentials credentials(final String scheme, final byte[] authToken) {
        Preconditions.checkArgument(CompareUtils.isNotBlank(scheme));
        ...
        return new Credentials() {
            ...
            public boolean equals(Object o) {
                ...
                return scheme.equals(other.scheme()) && Arrays.equals(authToken, other.authToken());
            }
     ...
     */
    public ZooKeeperClient(int sessionTimeout, InetSocketAddress zooKeeperServer,
     ...
     * @param zooKeeperServers any additional servers forming the ZK cluster
     */
    public ZooKeeperClient(int sessionTimeout, Credentials credentials,
        ...
        if (zooKeeper == null) {
            ...
            if (connectionTimeout > 0) {
                ...
                try {
                    ...
                    logger.info("Interrupted while waiting to connect to zooKeeper");
                    close();
                    throw ex;
                }
            }
